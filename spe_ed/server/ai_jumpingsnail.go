...
func init() {
	err := RegisterAI("JumpingSnailAI", func() AI { return new(JumpingSnailAI) })
	if err != nil {
		panic(err)
	}
}
...
// JumpingSnailAI behaves like SuperSnailAI but tries to jump out of small areas.
